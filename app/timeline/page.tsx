...
export default function TimelinePage() {
  return (
    <>
      <header className="relative pt-32 pb-12 px-6 sm:px-10 max-w-6xl mx-auto">
        ...
        <p className="font-mono text-base text-ink/70 mt-4 max-w-xl">
      ...
      <footer className="relative px-6 sm:px-10 py-20 max-w-6xl mx-auto text-center">
