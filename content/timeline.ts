...
export const TIMELINE: TimelineEvent[] = [
  ...
  },
  {
    year: "2019",
    title: "the first job",
    body: "top-60 finalist out of ~5,000 in TCS Hackquest 3.0. solving challenges for sport turned into a paycheck. security was just systems thinking with stakes.",
    tag: "CYBER",
  },
  {
    year: "2019",
    title: "security analyst, bhubaneswar",
    body: "70+ pentests and code reviews at TCS. then built a tool that correlated scanner output with real exploits — the first time I cared about the system around the work, not just the work.",
    tag: "CYBER",
  },
  {
    year: "2021",
    title: "nyu, cybersecurity",
    body: "a master's, and a CSAW CTF challenge written for the OSIRIS lab. learned that the best way to understand an attack is to build one.",
    tag: "CYBER",
  },
  {
    year: "2023",
    title: "arc xp, application security",
    body: "swept 70 assets, found DirtyPipe (CVE-2022-0847) in the wild, walked owners through the fix. the asymmetric weight of real systems — joy on one side, dread on the other.",
    tag: "CODE",
  },
  {
    year: "2024",
    title: "capital one, card onboarding",
    body: "senior software engineer. one tile moved setup reentry from 10% to 30%. my best work happened when I argued about the spec, not just the code.",
    tag: "PRODUCT",
  },
  {
    year: "2025",
